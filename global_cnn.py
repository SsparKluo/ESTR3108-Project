...
train_X, train_y, max_len0 = data_process.get_data(posi = "data\\CLIPSEQ_SFRS1.train.positives.fa", nega = "data\\CLIPSEQ_SFRS1.train.negatives.fa", channel = 1 )
test_X, test_y, max_len1 = data_process.get_data(posi = "data\\CLIPSEQ_SFRS1.ls.positives.fa", nega = "data\\CLIPSEQ_SFRS1.ls.negatives.fa", channel = 1)

if max_len0 > max_len1:
	max_len = max_len0 + 6
	test_X, test_y, max_len1 = data_process.get_data(posi = "data\\CLIPSEQ_SFRS1.ls.positives.fa", nega = "data\\CLIPSEQ_SFRS1.ls.negatives.fa", channel = 1, max_len = max_len0)
else:
	max_len = max_len1 + 6
	train_X, train_y, max_len0 = data_process.get_data(posi = "data\\CLIPSEQ_SFRS1.train.positives.fa", nega = "data\\CLIPSEQ_SFRS1.train.negatives.fa", channel = 1, max_len = max_len1)
